...
mmseqs convertalis --format-output "qseqid,sseqid,pident,length,mismatch,gapopen,qstart,qend,qlen,sstart,send,slen,evalue,bitscore" "$MMSEQDB" "$MMSEQDB" "${MMSEQDB%.*}_result" "${MMSEQDB%.*}_result.csv"
